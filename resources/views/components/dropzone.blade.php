...
<div {{ $attributes->merge(['class' => $class]) }} x-data="Dropzone()">
    ...
    <div class="mt-2 h-56 flex items-center justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md {{ $error }}">
        ...
        <div class="relative" x-show="image">
            ...
            <button @click="remove()" class="absolute top-0 right-0 mr-3 mt-3 rounded-full bg-gray-200">
