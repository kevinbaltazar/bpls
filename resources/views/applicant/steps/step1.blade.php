          ...
          <div class="pt-3">
              <div class="mt-1 grid grid-cols-1 gap-y-4 gap-x-4 sm:grid-cols-6">
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-1">
                        <input type="text" name="middle_name" value="{{$first['middle_name'] ?? old('middle_name')}}" id="middle_name" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Dela Cruz">
                    </div>
                ...
                <div class="sm:col-span-6">
                    ...
                    <div class="mt-1">
                        <input type="text" name="personal_address" value="{{$first['personal_address'] ?? old('personal_address')}}" id="personal_address" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md {{($errors->first('personal_address') ? " border-red-600" : "")}}" placeholder="Km 39, Pulong Buhangin, Santa Maria, Bulacan">
                    </div>
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-1">
                        <input type="text" name="business_name" value="{{$first['business_name'] ?? old('business_name')}}" id="business_name" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md {{($errors->first('business_name') ? " border-red-600" : "")}}" placeholder="Juan Dela Cruz Dimaano Motor Shop">
                    </div>
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-1">
                        <input type="text" name="business_address" value="{{$first['business_address'] ?? old('business_address')}}" id="business_address" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md {{($errors->first('business_address') ? " border-red-600" : "")}}" placeholder="Km 39, Pulong Buhangin, Santa Maria, Bulacan">
                    </div>
                ...
                <div class="sm:col-span-1">
                    ...
                    <div class="mt-1">
                        <input type="date" name="birthdate" value="{{$first['birthdate'] ?? old('birthdate')}}" id="birthdate" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md {{($errors->first('birthdate') ? " border-red-600" : "")}}">
                    </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-1">
                        <input type="text" name="birthplace" value="{{$first['birthplace'] ?? old('birthplace')}}" id="birthplace" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md {{($errors->first('birthplace') ? " border-red-600" : "")}}" placeholder="Santa Maria, Bulacan">
                    </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm">
                      ...
                      <input type="number" name="mobile_number"  value="{{$first['mobile_number'] ?? old('mobile_number')}}"  class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300 {{($errors->first('mobile_number') ? " border-red-600" : "")}}" placeholder="9551238299">
                    </div>
                ...
                <div class="sm:col-span-1">
                    ...
                    <div class="mt-1">
                        <input type="number" name="telephone_number" value="{{$first['telephone_number'] ?? old('telephone_number')}}"  id="birthplace" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="641-58-39">
                    </div>
                </div>
