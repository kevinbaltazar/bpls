        ...
        <div class="space-y-8">
            ...
            <div class="pt-3">
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-1">
                        <input type="text" name="last_name" id="zip" autocomplete="postal-code" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                    </div>
                </div>
                ...
                <div class="sm:col-span-1">
                    ...
                    <div class="mt-1">
                        <input type="text" name="mobile_number" id="birthdate" autocomplete="street-address" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                    </div>
                </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-1">
                        <input type="text" name="telephone_number" id="birthplace" autocomplete="street-address" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
                    </div>
                </div>
            </div>
        </div>
